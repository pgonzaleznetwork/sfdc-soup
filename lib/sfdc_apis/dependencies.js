...
function dependencyApi(connection,entryPoint){
    ...
    */
    ...
    async function enhanceCustomFieldData(dependencies){
        ...
        if(customFieldIds.length){
            ...
            let objectNamesById = await utils.getObjectNamesById(connection);
    ...
    async function createUnsupportedDependencies(dependencies){
        ...
        let records = await mdapi.readMetadata('CustomField',customFieldNames);
    ...
    async function createLookupFieldDependencies(lookupFields,customFieldsByName){
        ...
        let customObjectIdsByName = await utils.getObjectIdsByName(connection);
