...
const metadataModules = {
    CustomField: require('./metadata-types/CustomField'),
    CustomObject: require('./metadata-types/CustomObject'),
    ApexClass: require('./metadata-types/ApexClass'),
    EmailTemplate: require('./metadata-types/EmailTemplate'),
    Flow: require('./metadata-types/Flow'),
    StandardField: require('./metadata-types/StandardField'),
  };
...
function usageApi(connection,entryPoint,cache){
    ...
    async function seachAdditionalReferences(connection,entryPoint){
        ...
        try {
            ...
            let findReferencesFunction =  metadataModules[entryPoint.type];
