...
const cpqTree = {
    ...
    name:'Product2',
    fieldsToQuery:['Name','Id','IsActive'],
    children:[
        {
            name:'SBQQ__ProductOption__c',
            fieldsToQuery:['Id','Name','SBQQ__Product__c','SBQQ__Option__c'],
        },
        {
            name:'SBQQ_PriceRule__c',
            fieldsToQuery:['Id','Name','SBQQ__Product__c'],
            children:[
                {
                    name:'SBQQ_PriceCondition__c',
                    fieldsToQuery:['Id','Name','SBQQ__PriceRule__c'],
                },
                {
                    name:'SBQQ_PriceAction__c',
                    fieldsToQuery:['Id','Name','SBQQ__PriceRule__c','SBQQ__Product__c'],
                }
            ]
        }
    ]                
