...
function getCPQ(connection,entryPoint,cache){
...
const cpqTree = {
    ...
    children:[
        {   
            name: 'SBQQ__BlockPrice__c', 
            relationshipField: 'SBQQ__Product__c' ,
            children:[
                {
                    name: 'SBQQ__BlockPrice__c',
                    relationshipField: 'SBQQ__OriginalBlockPrice__c'
                } ,
                {
                    name: 'SBQQ__PriceTier__c',
                    relationshipField: 'SBQQ__OriginalBlockPrice__c'
                } ,
                {
                    name: 'SBQQ__QuoteLine__c',
                    relationshipField: 'SBQQ__BlockPrice__c',
                    children:[
                        {
                            name: 'SBQQ__AttributeValue__c',
                            relationshipField: 'SBQQ__QuoteLine__c'
                          } ,
                          {
                            name: 'SBQQ__BlockPrice__c',
                            relationshipField: 'SBQQ__QuoteLine__c'
                          } ,
                          {
                            ...
                            relationshipField: 'SBQQ__OriginalQuoteLine__c'
                          } ,
                          {
                          ...
                          {
                            name: 'SBQQ__PriceSchedule__c',
                            relationshipField: 'SBQQ__QuoteLine__c'
                          } ,
                          {
                            name: 'SBQQ__QuoteLineConsumptionSchedule__c',
                            relationshipField: 'SBQQ__QuoteLine__c'
                          } ,
                          {
                            name: 'SBQQ__QuoteLinePricingGuidance__c',
                            relationshipField: 'SBQQ__QuoteLine__c'
                          } ,
                          { name: 'SBQQ__QuoteLine__History', relationshipField: 'ParentId' } ,
                          {
                            name: 'SBQQ__QuoteLine__c',
                            relationshipField: 'SBQQ__RequiredBy__c'
                          } ,
                          { name: 'SBQQ__QuoteLine__c', relationshipField: 'SBQQ__Source__c' } ,
                          {
                            name: 'SBQQ__SubscribedQuoteLine__c',
                            relationshipField: 'SBQQ__AssetQuoteLine__c'
                          } ,
                          {
                            name: 'SBQQ__SubscribedQuoteLine__c',
                            relationshipField: 'SBQQ__SubscriptionQuoteLine__c'
                          } ,
                          {
        ...
        {
          name: 'SBQQ__ConfigurationRule__c',
          relationshipField: 'SBQQ__Product__c'
        } ,
        {
          name: 'SBQQ__ContractedPrice__c',
        ...
        { name: 'SBQQ__Cost__c', relationshipField: 'SBQQ__Product__c' } ,
        { name: 'SBQQ__Dimension__c', relationshipField: 'SBQQ__Product__c' } ,
        {
          name: 'SBQQ__DiscountSchedule__c',
          relationshipField: 'SBQQ__Product__c'
        } ,
        {
          name: 'SBQQ__FavoriteProduct__c',
          relationshipField: 'SBQQ__Product__c'
        } ,
        {
        ...
        { name: 'SBQQ__LookupData__c', relationshipField: 'SBQQ__Product__c' } ,
        {
          name: 'SBQQ__OptionConstraint__c',
          relationshipField: 'SBQQ__ConfiguredSKU__c'
        } ,
        { name: 'SBQQ__PriceRule__c', relationshipField: 'SBQQ__Product__c' } ,
        {
          name: 'SBQQ__PriceSchedule__c',
          relationshipField: 'SBQQ__Product__c'
        } ,
        {
          name: 'SBQQ__ProductAction__c',
          relationshipField: 'SBQQ__Product__c'
        } ,
        {
          name: 'SBQQ__ProductFeature__c',
          relationshipField: 'SBQQ__ConfiguredSKU__c'
        } ,
        {
        ...
        {
          name: 'SBQQ__ProductOption__c',
          relationshipField: 'SBQQ__OptionalSKU__c'
        } ,
        { name: 'SBQQ__QuoteLine__c', relationshipField: 'SBQQ__Product__c' } ,
        {
          name: 'SBQQ__RelatedContent__c',
          relationshipField: 'SBQQ__Product__c'
        } ,
        {
          name: 'SBQQ__Subscription__c',
        ...
        {
          name: 'SBQQ__Subscription__c',
          relationshipField: 'SBQQ__RequiredByProduct__c'
        } ,
        {
          name: 'SBQQ__UpgradeSource__c',
          relationshipField: 'SBQQ__SourceProduct__c'
        } ,
        {
          name: 'SBQQ__UpgradeSource__c',
          relationshipField: 'SBQQ__UpgradeProduct__c'
        } ,
        {
          name: 'SBQQ__WebQuoteLine__c',
          relationshipField: 'SBQQ__Product__c'
